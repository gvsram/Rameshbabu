...
WebUI.navigateToUrl('https://www.nopcommerce.com/')

WebUI.maximizeWindow()

WebUI.click(findTestObject('Object Repository/Nopcommerce/Registerlink'))

WebUI.setText(findTestObject('Datadriven_OR/Datadriven1/FirstName'), FirstName)

WebUI.setText(findTestObject('Datadriven_OR/Datadriven1/Lastname'), LastName)

WebUI.setText(findTestObject('Datadriven_OR/Datadriven1/E-Mail'), EMail)
